...
export const decisionMatrix = {
  ...
  hard: {
    ...
    2: {
      ...
      "12-14": playerChoices.hit,
      "15-20": playerChoices.stand,
    },
    3: {
      "5-9": playerChoices.hit,
      "10-11": playerChoices.double,
    ...
    4: {
      "5-9": playerChoices.hit,
      "10-11": playerChoices.double,
      "12-13": playerChoices.hit,
      "14-20": playerChoices.stand,
    },
    5: {
      "5-9": playerChoices.hit,
      "10-11": playerChoices.double,
  ...
  pairs: {
    2: {
      2: playerChoices.split,
      "3-4": playerChoices.hit,
    ...
    10: {
      "2-7": playerChoices.hit,
      "8-10": playerChoices.stand,
      11: playerChoices.split,
    },
    11: {
      "2-6": playerChoices.hit,
      "7-8": playerChoices.split,
      "9-10": playerChoices.stand,
      11: playerChoices.split,
    },
